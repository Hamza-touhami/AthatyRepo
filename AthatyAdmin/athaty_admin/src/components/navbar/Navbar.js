...
export default class Navbar extends Component {
  ...
  render() {
    return (
     <nav id="sidebarMenu" className="collapse d-lg-block sidebar collapse bg-white col-lg-3" Style={"height: 100%"}>
        <div className="position-sticky">
          <div className="list-group list-group-flush mx-3 mt-4">
            ...
            <a href="google.com" className="list-group-item list-group-item-action py-2 ripple active">
              <i className="fas fa-chart-area fa-fw me-3"></i><span>Categories</span>
            </a>
            <a href="google.com" className="list-group-item list-group-item-action py-2 ripple"
